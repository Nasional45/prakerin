                                ...
                                <tr>
                                    ...
                                    @foreach($kasus as $data)
                                        ...
                                        <tr>
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{route('kasus.edit',$data->id)}}" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="{{route('kasus.show',$data->id)}}" class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i></a>
