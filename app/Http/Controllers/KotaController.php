...
class KotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kota->save();
        return redirect()->route('kota.index')->with(['succes'=>'Data Berhasil diinput']);
    }
    ...
    public function destroy($id)
    {
        $kota = Kota::findOrFail($id);
        $kota->delete();
        return redirect()->route('kota.index')->with(['success'=>'Data <b>',$kota->nama_kota,'</b> Berhasil dihapus']);
    }
}
