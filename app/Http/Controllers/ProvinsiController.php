...
class ProvinsiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $provinsi->save();
        return redirect()->route('provinsi.index')->with(['succes'=>'Data <b>',$provinsi->nama_provinsi,'</b> Berhasil diinput']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $provinsi->nama_provinsi =$request->nama_provinsi;
        $provinsi->save();
        return redirect()->route('provinsi.index')->with(['success'=>'Data <b>',$provinsi->nama_provinsi,'</b> Berhasil diedit']);
    }
